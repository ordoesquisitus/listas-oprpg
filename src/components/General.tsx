import generalAbilitiesData from '../data/general-abilities.json';
import generalPathsData from '../data/general-paths.json';
                      ...
                      <div className="card h-100 text-bg-dark text-light border-light">
                        <div className="card-body">
                          ...
                          <p className="card-text">
                            ...
                            {path.nex10.description}
                          </p>
                          <p className="card-text">
                            <strong>40% - {path.nex40.name}. </strong>
                            {path.nex40.description}
                          </p>
                          <p className="card-text">
                            <strong>65% - {path.nex65.name}. </strong>
                            {path.nex65.description}
                          </p>
                        </div>
                      </div>
                    </div>
